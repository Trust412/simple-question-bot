        ...
        <div className="flex-1 overflow-y-auto p-4 flex flex-col scrollbar-thin">
          ...
          {currentSession?.messages.length === 1 && (
            <div className="flex flex-col gap-2 mt-2 max-w-xs">
              <Button 
                variant="outline" 
                className="justify-start border-bot hover:bg-gray-200"
          ...
          {isTyping && (
            <div className="self-start bg-gray-200 text-gray-800 py-3 px-4 max-w-[85%] rounded-lg mb-2 rounded-bl-none animate-pulse">
              Typing...
            </div>
          )}
